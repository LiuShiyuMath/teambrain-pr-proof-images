# TeamBrain PR proof-of-work images

这个仓库只作为图片 host 使用，保存 TeamBrain merged PR 的中文 proof-of-work 卡片。
...
Images live under [images/](images/). Machine-readable index: [manifest.json](manifest.json).
